...
const Footer = () => {
  return (
    <div className="relative bg-white">
      <footer className="w-full text-white" style={{ backgroundColor: "#0D1C2E" }}>
        {/* Main Footer Section */}
        <section className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <article>
              <div className="flex items-center mb-6">
                <Building2 size={48} className="flex-shrink-0" style={{ color: "#00BFB6" }} />
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
                ...
                we are still here for you even after the project is complete.
              </p>
            </article>
          ...
          {links1.map((link, index) => (
            <li key={index}>
              ...
              >
                <ChevronRight size={18} className="mr-2 mt-0.5" style={{ color: "#00BFB6" }} />
          ...
          >
            ...
            <article>
              ...
              <div className="flex items-start mb-4">
                <Phone size={24} className="flex-shrink-0 mt-1" style={{ color: "#00BFB6" }} />
                <a href="tel:+18091206705" className="ml-3 text-gray-300 hover:text-white transition">
                  +1 809 120 6705
                </a>
              </div>
              <div className="flex items-start mb-4">
                <Mail size={24} className="flex-shrink-0 mt-1" style={{ color: "#00BFB6" }} />
                <a href="mailto:info@domain.com" className="ml-3 text-gray-300 hover:text-white transition">
                  info@domain.com
                </a>
              </div>
              <div className="flex items-start">
                <MapPin size={24} className="flex-shrink-0 mt-1" style={{ color: "#00BFB6" }} />
