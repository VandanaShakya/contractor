...
import { serviceData, services, workflowSteps, featuresData } from "../data/data";
...
const fadeUp = {
  ...
  show: (custom = 0) => ({ opacity: 1, y: 0, transition: { duration: 0.55, delay: 0.04 * custom } }),
};

const fadeIn = {
  hidden: { opacity: 0 },
  show: (custom = 0) => ({ opacity: 1, transition: { duration: 0.55, delay: 0.04 * custom } }),
};
  ...
  return (
    <>
      ...
      <div className="relative w-full min-h-screen">
        {/* Fixed full-bleed image placed behind content */}
        <img
        ...
        {/* HERO container (content sits above the fixed bg) */}
        <section id="home" className="relative z-20 w-full min-h-screen">
          {/* Navbar inside hero so it visually sits on the same image */}
          ...
          >
            <motion.p variants={heroVariants} className="text-sm md:text-base tracking-widest mb-2">
              WELCOME TO BUILT-UP
            </motion.p>
            ...
            <motion.p variants={heroVariants} className="text-base sm:text-lg max-w-3xl mb-8 px-2">
            ...
            <motion.div variants={heroVariants} className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="bg-[#00BFB6] hover:bg-white/20 hover:border-white hover:cursor-pointer text-white font-semibold py-3 px-8 rounded-full transition duration-300 ease-in-out">
                Get Started
              ...
              <button className="bg-white/10 hover:bg-[#00BFB6] text-white font-semibold py-3 px-8 rounded-full border border-white hover:cursor-pointer transition duration-300 ease-in-out">
                View Projects
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 inline-block ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                </svg>
      ...
      <div className="relative pb-10 lg:pb-14 bg-white">
        <div className="bg-[#F5F7F9] flex justify-center items-center py-10 px-4 font-inter">
          ...
          <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8">
            {/* Left Side: Welcome Text and Description (Takes 5 columns on desktop) */}
            <motion.div
            ...
            {/* Right Side: Service Icons Grid (Takes 7 columns on desktop) */}
            <motion.div
              ...
              variants={staggerContainer}
            >
              <motion.div className="grid grid-cols-2 md:grid-cols-3 gap-y-12 gap-x-6 pt-8 w-full" variants={staggerContainer}>
                {services.map((service, index) => {
                  const Icon = service.Icon;
                  return (
                    <motion.div key={index} className="flex flex-col items-center text-center p-4" variants={fadeIn} custom={index}>
                      <Icon className="mb-4" size={56} color={ICON_COLOR} strokeWidth={1} />
                      <p className="text-lg font-medium text-gray-700 leading-snug">{service.title}</p>
                    </motion.div>
                  );
                })}
              </motion.div>
      ...
      <div className="relative py-16 lg:py-24 bg-white">
        <div className="min-h-screen bg-[#f7fafd] py-16 md:py-24 font-inter">
          {/* Content Container (Max width for desktop, centered) */}
          <div className="container mx-auto px-6 max-w-7xl">
            {/* Header Section */}
            <header className="text-center mb-16 md:mb-20">
              <motion.p initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="text-sm tracking-widest font-bold text-[#00BFB6] uppercase mb-3">
                OUR SERVICES
              </motion.p>
              <motion.h1 initial="hidden" whileInView="show" viewport={{ once: true }} variants={heroVariants} className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#1f2937] leading-tight">
                Our construction services
              </motion.h1>
              <motion.p initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="mt-4 max-w-3xl mx-auto text-lg text-gray-500">
                ...
                >
                  ...
                  <motion.img
                    ...
                    onError={(e) => {
                      ...
                      e.target.src = "https://placehold.co/600x600/cccccc/000000?text=Image+Error";
                    }}
                  ...
                  <div className="absolute bottom-0 left-0 p-8 text-white">
                    <h3 className="text-3xl font-semibold mb-2 leading-tight">{service.title}</h3>
                  </div>
                </motion.div>
              ))}
            </section>
      ...
      <section className="relative py-16 lg:py-24 px-4 sm:px-6 lg:px-8 bg-white">
        ...
        <div className="max-w-7xl mx-auto pt-5 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md aspect-[4/5] sm:aspect-[3/4] lg:aspect-[4/5] xl:aspect-[3/4] overflow-hidden rounded-3xl shadow-xl">
              <img src={images.homeLeftImage} alt="Two construction workers standing confidently" className="absolute inset-0 w-full h-full object-cover" />
            </div>
          </div>
          ...
          <div className="lg:pl-12">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">
              Crafting structures that <br className="hidden sm:inline" /> last a lifetime
            </h2>
            <p className="text-gray-600 text-base lg:text-lg mb-8">
              Crafting structures that last a lifetime requires a holistic approach that
              integrates advanced materials, resilient design, regular maintenance, and
              sustainability practices. By learning from historical examples and leveraging
              modern technology.
            </p>

            <div className="bg-blue-50 bg-opacity-70 rounded-xl p-6 mb-8">
              <div className="flex items-center mb-4">
                <svg className="w-6 h-6 text-[#00BFA6] mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-800 text-lg font-medium">Comprehensive Services</span>
              </div>
              <div className="flex items-center mb-4">
                <svg className="w-6 h-6 text-[#00BFA6] mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-800 text-lg font-medium">Advanced Technology</span>
              </div>
              <div className="flex items-center">
                <svg className="w-6 h-6 text-[#00BFA6] mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-gray-800 text-lg font-medium">Transparent Communication</span>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row items-center sm:space-x-8 space-y-6 sm:space-y-0">
              <button className="bg-[#00BFB6] hover:bg-[#00a48f] text-white font-semibold py-3 px-8 rounded-full flex items-center justify-center transition duration-300 ease-in-out w-full sm:w-auto">
                Get Free Quote
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-bold text-lg">+1 809 120 6705</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* second block */}
        <div className="max-w-7xl mx-auto pt-5 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Image Section */}
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md aspect-[4/5] sm:aspect-[3/4] lg:aspect-[4/5] xl:aspect-[3/4] overflow-hidden rounded-3xl shadow-xl">
              <img src={images.homeSecondImage} alt="Two construction workers standing confidently" className="absolute inset-0 w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="relative py-16 lg:py-24 px-4 lg:px-8 bg-white">
        <section className="py-16 sm:py-24 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            {/* Title */}
            <motion.h2 initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="text-3xl sm:text-4xl font-bold text-center text-gray-800 mb-12 sm:mb-16">
              How It Works
            </motion.h2>

            {/* Workflow Steps Container */}
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} variants={staggerContainer} className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
              {workflowSteps.map((item, index) => (
                <React.Fragment key={item.step}>
                  {/* Individual Step Container (Circle + Text) */}
                  <motion.div className="flex flex-col items-center text-center w-full sm:w-1/4 mb-12 sm:mb-0 relative" variants={fadeUp} custom={index}>
                    {/* Step Circle */}
                    <div className="w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center 
                                rounded-full bg-gray-100 text-2xl font-semibold text-blue-800 
                                border-4 border-gray-200 shadow-md transition duration-300 ease-in-out">
                      {item.step}
                    </div>
                  ...
                  {index < workflowSteps.length - 1 && (
                    <div className="flex-grow flex items-center justify-center h-full sm:h-auto">
                      ...
                      <div className="hidden sm:block w-full mx-2 lg:mx-4 h-px bg-gray-300"></div>

                      {/* Vertical Line for Mobile (Flex-grow pushes it between the steps) */}
                      <div className="sm:hidden absolute top-0 bottom-0 left-1/2 transform -translate-x-1/2 
                                  w-px h-24 bg-gray-300 -mt-12 -mb-12"></div>
                    </div>
                  )}
                </React.Fragment>
              ))}
